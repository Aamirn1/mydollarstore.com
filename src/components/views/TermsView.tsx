      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-8">
        ...
        >
          {[
            ...
            { title: 'Shipping and Delivery', content: 'Shipping times are estimates and may vary based on location and product availability. We are not responsible for delays caused by carriers, customs, or unforeseen circumstances. Free shipping applies to orders over PKR 15,000 within Pakistan.' },
